...
<div class="jumbotron">
<div class="container">
  <h2 class= "text-center"> Taking the hassel out of creating schedules </h2>  
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="image.jpg" alt="Los Angeles" style="width:100%;">
      </div>
      ...
      <div class="item">
        <img src="image3.jpg" alt="New york" style="width:100%;">
	        ...
	        <div class="item">
        <img src="image4.jpg" alt="New york" style="width:100%;">
      </div>
    </div>
...
<div class="container text-center">    
  ...
  <div class="row">
    <div class="col-sm-4">
      <p>Create a schedule that suits your needs for your requirements and specifications with online templates.</p>
    </div>
    <div class="col-sm-4"> 
      <p>Create schedules with peace of mind with lecturer availability checks and double booking validations.</p>    
    </div>
	<div class="col-sm-4"> 
      <p>User friendly dashboard illustrating student, supervisor and slot information. </p>    
    </div>
